...
|---|---|---|---|---|
| pipeline-or-parts | Is it a fixed pipeline you follow, or modular parts you compose? | judged | 3 | fixed_pipeline -1, mixed +0, composable +1 |
| step-order | Are steps mandatory and ordered, or optional and reorderable? | judged | 2 | mandatory_ordered -1, mixed +0, optional_reorderable +1 |
<!-- END GENERATED -->
